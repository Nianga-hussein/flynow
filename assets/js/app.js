...
// Template URL: https://nianga-hussein.github.io/Porfolio/
  ...
  var Init = {
    ...
    initializeSlick: function (e) {
      if ($(".flight-card-slider").length) {
        // MOKO: Content is populated by index-categories.js, do not empty or overwrite here.
        /*
        ...
        if (typeof mokoCategories !== 'undefined') {
             // ... logic removed to avoid conflict ...
        }
        */
